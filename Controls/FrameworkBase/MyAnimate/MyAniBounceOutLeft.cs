...
{
    public class MyAniBounceOutLeft : MyAnimateBase
    {
        public MyAniBounceOutLeft(UIElement _element)
            : base("BounceOutLeft", _element)
        { base.AnimateSpeed = 900; }

        public MyAniBounceOutLeft(UIElement _element, Action _completed)
