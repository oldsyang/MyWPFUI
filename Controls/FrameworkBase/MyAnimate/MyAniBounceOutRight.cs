...
{
    public class MyAniBounceOutRight : MyAnimateBase
    {
        public MyAniBounceOutRight(UIElement _element)
            : base("BounceOutRight", _element)
        { base.AnimateSpeed = 900; }

        public MyAniBounceOutRight(UIElement _element, Action _completed)
