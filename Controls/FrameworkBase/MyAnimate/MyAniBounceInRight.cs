...
{
    public class MyAniBounceInRight : MyAnimateBase
    {
        public MyAniBounceInRight(UIElement _element)
            : base("BounceInRight", _element)
        { base.AnimateSpeed = 800; }

        public MyAniBounceInRight(UIElement _element, Action _completed)
