...
{
    public class MyAniSlideOutRight : MyAnimateBase
    {
        public MyAniSlideOutRight(UIElement _element)
            : base("SlideOutRight", _element)
        { base.AnimateSpeed = 300; }

        public MyAniSlideOutRight(UIElement _element, Action _completed)
