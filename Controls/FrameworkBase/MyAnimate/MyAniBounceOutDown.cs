...
{
    public class MyAniBounceOutDown : MyAnimateBase
    {
        public MyAniBounceOutDown(UIElement _element)
            : base("BounceOutDown", _element)
        { base.AnimateSpeed = 900; }

        public MyAniBounceOutDown(UIElement _element, Action _completed)
